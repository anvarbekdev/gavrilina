...
export default function Home() {
  return (
    <>
      ...
      {/* New Collection */}
      <div
        className="container mx-auto flex max-h-screen   px-4 md:px-6 my-10 md:my-25"
        id='collection'
      >
        {/* Cobination Slider */}
        <CombinationSlider />
        ...
        {/* Collection products */}
        <div className="overflow-auto  bg-[#f6f6f6] scrollbar-none">
          {products
            ...
            .map((product, index) => (
              ...
              >
                {/* Image Container */}
                <div className="image-container cursor-pointer relative  overflow-hidden ">
